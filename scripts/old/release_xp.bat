...
xcopy %fm_dir%\bin\mfc70.dll %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\msvcp70.dll %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\msvcr70.dll %to_dir%anadll\ /e /h /i
xcopy %fm_dir%\bin\Shell32.dll %to_dir%anadll\ /e /h /i
...
xcopy C:\WINDOWS\SYSTEM32\MFC42.DLL %to_dir%anadll\ /h
xcopy C:\WINDOWS\SYSTEM32\MFC42D.DLL %to_dir%anadll\ /h
xcopy C:\WINDOWS\SYSTEM32\MSVCP60D.DLL %to_dir%anadll\ /h
xcopy C:\WINDOWS\SYSTEM32\MSVCRT.DLL %to_dir%anadll\ /h
xcopy C:\WINDOWS\SYSTEM32\MSVCRTD.DLL %to_dir%anadll\ /h
rem 01/08/02 AM.
xcopy C:\I386\MSVCP60.DLL %to_dir%anadll\ /h
