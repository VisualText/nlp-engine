...
rem	02/05/01 AM. Renaming this to DISTDEV.  "Developer's release, source + binary".
...
xcopy %fm_dir%\bin %to_dir%\bin /e /h /i
...
xcopy %fm_dir%\lib %to_dir%\lib /e /h /i
del %to_dir%\lib\CJ608Lib.lib
del %to_dir%\lib\CJ608Libd.lib
del %to_dir%\lib\zlib.lib

xcopy %fm_dir%\scripts %to_dir%\scripts /e /h /i

rem 07/02/00 AM. Save my changes to the template analyzers.
xcopy %fm_dir%\VisualText\App %to_dir%\VisualText\App /e /h /i
