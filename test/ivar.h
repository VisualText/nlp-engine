...
public:
   ...
   static bool nodeVarEQ(Pn*,_TCHAR*,long);                       // 06/16/05 AM.
	static bool nodeReplaceval(Pn*,_TCHAR*,RFASem*);					// 06/26/01 AM.
	static bool nodeReplaceval(Pn*,_TCHAR*,Dlist<Iarg>*);			// 11/14/02 AM.
	static bool nodeReplaceval(Pn*,_TCHAR*,_TCHAR*);						// 06/26/01 AM.
	static bool nodeReplaceval(Pn*,_TCHAR*,long);						// 06/26/01 AM.
